...
public class CusOder extends JFrame {
	...
	public CusOder() {
		...
		String[] cluname = { "姓名名", "药品名", "数量", "价格" };
		List<ViewOrder> orders = ViewOrderDao.findOrdersByNane(customer.getName());
